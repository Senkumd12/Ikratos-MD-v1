...
│╭────────────────···
┴│    *${ucapan()} %name!*
⬡│☂︎ *التاريخ:* %week %weton
⬡│☂︎ *الوقت:* %date
⬡│☂︎ *التوقيت الاسلامي:* %dateIslamic
┬│☂︎ *وقت:* %time
│╰────────────────···
┠─────═[ BoT ]═─────⋆
│╭────────────────···
...
⬡│☂︎ *بريفيكس البوت:* [ *%_p* ]
⬡│☂︎ *الاب تايم:* %muptime
┬│☂︎ *مسجل او لا:* %rtotalreg dari %totalreg
│╰────────────────···
╰──────────═┅═──────────
...
let handler = async (m, { conn, usedPrefix: _p, __dirname, args, command}) => {
  ...
  'vote': 'Voting',
  'absen': 'Absen',
  'premium': 'اوامر المميزين',
  'anonymous': 'الرسائل المجوهولة',
  'internet': 'التصفح',
  'downloader': 'التنزيلات',
  'tools': 'الادوات',
  'nulis': 'التصاميم',
  'audio': 'تعديل الايوديو',
  'maker': 'انشاءات او ماكر',
  'database': 'Database',
  'quran': 'Al Qur\'an',
  'owner': 'اوامر المطور',
  'advanced': 'Advanced',
